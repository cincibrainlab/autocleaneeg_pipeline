#!/usr/bin/env python3
"""
BDF Import Visual Diagnostic Report - Enhanced v3 (Academic Style)

Academic-style validation report with HTML output, comprehensive visualizations,
and metadata analysis. All rows displayed, appropriate for scientific publications.

Usage: uv run test_bdf_visual_v3.py [bdf_file] [montage_name] [output_dir]
"""
    ...
    <div class="container">
        <div class="header">
            ...
            <div style="margin-top: 15px; font-size: 12px; color: #666;">
                <strong>File:</strong> {Path(bdf_file).name} &nbsp;|&nbsp;
                <strong>Montage:</strong> {montage_name} &nbsp;|&nbsp;
                <strong>Generated:</strong> {timestamp}
            </div>
        </div>

        <div class="verdict {verdict_class}">
            <div style="margin-bottom: 8px;">{verdict_icon} {verdict_title}</div>
        ...
        <div class="footer">
            <div>EEG Channel Validation Report v3.0 (Academic Style)</div>
            <div style="margin-top: 8px;">Generated by AutoClean EEG Pipeline</div>
        </div>
    </div>
</body>
</html>"""
...
def main():
    ...
    console.print("\n[bold cyan]═══════════════════════════════════════════════════════════[/bold cyan]")
    console.print("[bold cyan]    BDF Visual Validation Report v3 (Academic Style)[/bold cyan]")
