...
class BDFBiosemi64Plugin(BaseEEGPlugin):
    ...
    def import_and_configure(
        ...
        try:
            ...
            # Step 2: Configure the biosemi64 montage
            message("info", "Configuring biosemi64 montage")

            # Apply BioSemi 64-channel standard montage
            montage = mne.channels.make_standard_montage("biosemi64")
            raw.set_montage(montage, match_case=False, on_missing="warn")

            message("success", "Successfully applied biosemi64 montage")
