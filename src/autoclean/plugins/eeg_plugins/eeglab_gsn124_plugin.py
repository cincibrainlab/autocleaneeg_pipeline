...
class EEGLABSetGSN124Plugin(BaseEEGPlugin):
    ...
    def import_and_configure(self, file_path: Path, autoclean_dict: dict, preload: bool = True):
        ...
        message("info", f"Loading EEGLAB .set file with GSN-HydroCel-124 montage: {file_path}")
        ...
        try:
            ...
            raise RuntimeError(f"Failed to process EEGLAB file with GSN-HydroCel-124 montage: {str(e)}")
