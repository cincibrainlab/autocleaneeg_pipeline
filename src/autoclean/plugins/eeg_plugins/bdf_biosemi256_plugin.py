...
class BDFBiosemi256Plugin(BaseEEGPlugin):
    ...
    def import_and_configure(
        ...
        message(
            "info", f"Loading BioSemi BDF file with biosemi256 montage: {file_path}"
        )
        ...
        try:
            ...
            # Apply BioSemi 256-channel standard montage
            montage = mne.channels.make_standard_montage("biosemi256")
            raw.set_montage(montage, match_case=False, on_missing="warn")

            message("success", "Successfully applied biosemi256 montage")
