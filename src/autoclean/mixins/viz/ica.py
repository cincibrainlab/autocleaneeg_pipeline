...
class ICAReportingMixin:
    ...
    def plot_ica_vision_results(self):
        ...
        if not hasattr(self, "ica_vision_flags") or self.ica_vision_flags is None:
            message(
                "error",
                "ICA vision classification results not found. Please run classify_ica_components_vision first.",
            )
            return None
        ...
        ax_summary.set_title(
            "ICA Components Classification Summary (OpenAI Vision)", fontsize=14
        )
