...
class ReferenceMixin:
    ...
    def set_eeg_reference(
        ...
        try:
            ...
            if ref_type == "average":
                result_raw = data.copy().set_eeg_reference(
                    ref_type, projection=projection
                )
            else:
            ...
            # Update metadata
            metadata = {"reference_type": ref_type, "projection": projection}
