...
# =============================================================================
# This task mirrors RestingState_Basic but targets GSN-HydroCel-128 datasets.
...
class RestingState_Basic_128(Task):
    """Task implementation for resting-state preprocessing on HydroCel-128 data."""
