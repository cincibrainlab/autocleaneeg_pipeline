        ...
        try:
            ...
            if operation == "create_collection":
                ...
                if operation == "update_status":
                    record["status"] = f"{update_record['status']} at {datetime.now().isoformat()}"
                else:
                    ...
                    record.update({k: v for k, v in update_record.items() if k != "metadata"})
                ...
                record = collection.filter(lambda x: x["run_id"] == run_record["run_id"])
