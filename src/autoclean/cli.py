...
from autoclean.cli_logging import log_cli_execution, strip_wrapping_quotes
from autoclean.cli_help import (attach_rich_help, _simple_header, _print_startup_context, _print_root_help, LOGO_ICON, TAGLINE)
...
def cmd_source_set(args) -> int:
    ...
    try:
        ...
        source_path = strip_wrapping_quotes(source_path)
        ...
        selected_source = strip_wrapping_quotes(selected_source)
