...
async def main():
    ...
    EXAMPLE_OUTPUT_DIR = Path("C:/Users/Gam9LG/Documents/DATA/stat_learning/autoclean_output")  # Where processed data will be stored
    ...
    directory = Path("C:/Users/Gam9LG/Documents/DATA/stat_learning")
