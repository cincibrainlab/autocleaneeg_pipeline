...
## Intent
Implement the RFC 019 multi-route serve model and the RFC 020 review adjustments across config parsing, routing, queue and ledger metadata, CLI validation and reporting, and tests, and record plain-English decisions for the open questions.
...
6. Add plain-English responses that capture the current decisions for the open questions.
