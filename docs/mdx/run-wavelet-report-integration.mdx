...
<Steps>
  ...
  <Step title="What changed?">
    <ul>
      <li>Merged the report helpers, dataclass container, and constants into <code>src/autoclean/mixins/signal_processing/wavelet_threshold/processing.py</code>.</li>
...
scripts/wavelet_report.py -> loads mixins/signal_processing/wavelet_threshold/processing.py
...
2. Inspect <code>src/autoclean/mixins/signal_processing/wavelet_threshold/processing.py</code> to confirm both the cleaner and report helpers are present.
