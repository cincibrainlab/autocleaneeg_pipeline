...
`wavelet_threshold` and `generate_wavelet_report` now live beside the mixin inside `src/autoclean/mixins/signal_processing/wavelet_threshold/`. Drop that folder into a lightweight environment to retain both cleaning and reporting.
